...
public class ReadyBuyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println("<a href=\"buyGoodsServlet\">确认订单</a>");
        //resp.getWriter().println("<a href= \"list.html\">取消</a>");
        resp.getWriter().println("<form action=\"list.html\" method=\"post\"><button type=\"submit\">取消订单</button></form>");
